...
## 💼 What I Do
- 🧠 Explore AI, Machine Learning, and Intelligent Systems  
- 📊 Data Analysis & Problem Solving using Python, C, and C++  
- 🌐 Web Development & Full-Stack Basics with HTML, CSS, and JavaScript  
- 🤝 Team Leadership and Student Committee Activities  
- 📚 Academic Research & Personal Project Development  

---

## 🔍 Currently Working On
- **Personal Projects** – Building practical AI and CS projects to strengthen problem-solving and coding skills.  
- **Academic Research** – Exploring AI applications and algorithms through coursework and experiments.  
- **IEEE PUA SB Activities** – Leading publicity initiatives and managing team projects.  

---

## 🚀 Featured Projects
### 🧠 AI & Machine Learning
- Neural network experiments for small-scale projects  
- Algorithmic problem-solving exercises  

### 🌐 Web & Software Projects
- Responsive HTML/CSS/JS websites  
- Mini-games and interactive applications in Python  

### 🤝 Team Projects
- Collaborative projects at IEEE PUA SB  
- Academic group projects applying CS and AI concepts  
